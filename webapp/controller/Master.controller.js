/*global history */
sap.ui.define([
	"de/computerservice-wolf/iotui5/maintain/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"de/computerservice-wolf/iotui5/maintain/model/formatter",
	"sap/m/MessageBox",
	"de/computerservice-wolf/iotui5/maintain/model/grouper",
	...
	return BaseController.extend("de.computerservice-wolf.iotui5.maintain.controller.Master", {
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("device", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("de.computerservice-wolf.iotui5.maintain.view.ViewSettingsDialog", this);

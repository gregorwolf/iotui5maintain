sap.ui.define([
	...
	return BaseController.extend("de.computerservice-wolf.iotui5.maintain.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("sensors", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("sensors", oData);

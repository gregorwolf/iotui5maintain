sap.ui.define([
	...
	opaTest("MasterList Filtering on lastMeasurement less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("lastMeasurement").
		and.iSelectListItemInViewSettingsDialog("<100 description").
	...
	opaTest("MasterList Filtering on lastMeasurement more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 description").
		and.iPressOKInViewSelectionDialog();

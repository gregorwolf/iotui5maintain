sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/computerservice-wolf/iotui5/maintain/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("de.computerservice-wolf.iotui5.maintain.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["de/computerservice-wolf/iotui5/maintain/localService/mockserver"], function(mockserver) {
